...
$level = trim(mysqli_real_escape_string($connect, $_POST['level']));

$sql_login = mysqli_query($connect, "SELECT * FROM tb_user WHERE username = '$username' AND password = '$password' AND level = '$level'") or die(mysqli_error($connect));
