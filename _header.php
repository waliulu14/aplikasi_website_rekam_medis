...
<head>
    ...
    <title>Aplikasi Puskesmas Bukit Sileh</title>
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li class="sidebar-brand">
                    <a href="#">
                        <img class="mb-4" src="<?= base_url() ?>/_assets/images/logo.svg" alt="" width="52" height="27">Puskesmas Bukit Sileh
                    </a>
                ...
                <li>
                    <a href="<?= base_url('poliklinik') ?>">Data Ruangan</a>
                </li>
                <li>
